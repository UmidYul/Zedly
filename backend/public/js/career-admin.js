...
const CareerAdminManager = {
    ...
    openCreateTestModal() {
        // Временно скрыто для пользователей
        const modal = document.createElement('div');
        modal.className = 'modal-overlay';
        modal.innerHTML = `<div class="modal"><div class="modal-header"><h2>Under Development</h2><button class="modal-close" onclick="this.closest('.modal-overlay').remove()">×</button></div><div class="modal-body"><p style="text-align:center;font-size:1.2em;">Страница профтестов для администратора находится в разработке.</p></div></div>`;
        document.body.appendChild(modal);
        // Оригинальный код модалки сохранён ниже (закомментирован)
        /*
